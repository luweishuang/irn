...
if __name__ == '__main__':
    ...
    parser.add_argument("--voc12_root", default='voc12/data/VOC12/train', type=str,
                        help="Path to VOC 2012 Devkit, must contain ./JPEGImages as subdirectory.")

    # Dataset
    parser.add_argument("--train_list", default="voc12/train_aug.txt", type=str)
    parser.add_argument("--val_list", default="voc12/val.txt", type=str)
    parser.add_argument("--infer_list", default="voc12/infer.txt", type=str,
    ...
    parser.add_argument("--cam_batch_size", default=64, type=int)
    ...
    parser.add_argument("--cam_out_dir", default="result/infer/cam", type=str)
    parser.add_argument("--ir_label_out_dir", default="result/infer/ir_label", type=str)
    parser.add_argument("--sem_seg_out_dir", default="result/infer/sem_seg", type=str)
    parser.add_argument("--ins_seg_out_dir", default="result/infer/ins_seg", type=str)
